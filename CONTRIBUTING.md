...
title:  "ZIO-Netty Contributor Guidelines"
---

Thank you for your interest in contributing to ZIO-Netty, which is a type-safe way to create Netty connections against other Java Applications

We welcome contributions from all people! You will learn about functional programming, and you will add your own unique touch to the ZIO-Netty project. We are happy to help you to get started and to hear your suggestions and answer your questions.

_You too can contribute to ZIO-Netty, we believe in you!_
...
mkdir zio-netty
cd zio-netty
git clone git@github.com:your-user-name/zio-netty.git .
```

If these steps were successful, then congratulations, you now have a complete copy of the ZIO-Netty project!
...
The main project in ZIO-Netty is `coreJVM` (the core project on the JVM; there is also `coreJS` for the core project on Scala.js), which you can focus on using sbt by issuing the following command:
...
If some issue is confusing or you think you might need help, then just post a comment on the issue asking for help. Typically, the author of the issue will provide as much help as you need, and if the issue is critical, leading ZIO-Netty contributors will probably step in to mentor you and give you a hand, making sure you understand the issue thoroughly.
...
Once you have an issue, the next step is to fix the bug or implement the feature. Since ZIO-Netty is an open source project, there are no deadlines. Take your time!
...
Now while you were working on this great improvement, it's quite likely that other ZIO-Netty contributors were making their own improvements. You need to pull all those improvements into your own code base to resolve any conflicts and make sure the changes all work well together.
...
Once you have a pull request open, it's still your job to get it merged! To get it merged, you need at least one core ZIO-Netty contributor to approve the code.
...
Once you receive a review, you will probably have to go back and make minor changes that improve your contribution and make it follow existing conventions in the code base. This is normal, even for experienced contributors, and the rigorous reviews help ensure ZIO-Netty's code base stays high quality.
...
Sit back, relax, and enjoy being a ZIO-Netty contributor!

# ZIO-Netty Contributor License Agreement

Thank you for your interest in contributing to the ZIO-Netty open source project.
